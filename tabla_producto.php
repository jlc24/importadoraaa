            ...
            <tr>
                ...
                <td align="center"> 
                    <?php
                        if ($registro["prod_imagen"] != "") { ?>
                            <a href="javascript:void(0);" title="Ver Imagen"><img src="<?php echo $registro["prod_imagen"]; ?>" class="img-thumbnail rounded mx-auto d-block image btnVerImagen" id="image" width="100px"></a>
                        <?php
                        }else{ ?>
                            <a href="javascript:void(0);" title="Subir imagen"><img src="assets/images/default/404.png" class="img-thumbnail rounded mx-auto d-block btnAgregarImagen" width="100px"></a>
                        <?php
                        }
                    ?>
                </td>
                ...
                <td align="center">
                    <div class="btn-group" role="group" aria-label="Basic mixed styles example">
                        ...
                        <a class="btn btn-outline-primary btnhistorialProducto" type="button" href="javascript:void(0);" title="Historial Compras">
