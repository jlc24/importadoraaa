                ...
                <form class="form-horizontal" id="formulario_abastecer_producto">
                    ...
                    <input type="text" id="prod_id_abastecer" name="prod_id_abastecer" readonly hidden>
                        ...
                        <div class="form-group col-lg-3">
                            ...
                            <input type="number" min="0" style="font-weight: 500; background-color:#EBF9D6;" class="form-control form-control-sm" id="precio_compra_anterior" name="precio_unitario_anterior" readonly="" value="">
                        </div>
                        <div class="form-group col-lg-3">
                        ...
                        <div class="form-group col-lg-2">
                            ...
                            <input type="number" min="1" value="0" class="form-control form-control-sm" id="cantidad_comprada_abastecer" name="cantidad_comprada_abastecer">
                        </div>
                        <div class="form-group col-lg-3">
                            <label class="col-form-label">Precio Compra (Bs)</label>
                            <input type="number" min="0" value="0" class="form-control form-control-sm" id="precio_compra_abastecer" name="precio_compra_abastecer">
                        </div>
                        
                        <div class="form-group col-lg-3">
                            <label class="col-form-label">Precio Unitario (Bs)</label>
                            <input type="number" min="0" value="0" class="form-control form-control-sm" id="precio_unitario_abastecer" name="precio_unitario_abastecer" readonly>
                        </div>
                        <div class="form-group col-lg-3">
                            <label class="col-form-label">Precio Venta (Bs)</label>
                            <input type="number" min="0" value="0" class="form-control form-control-sm" id="precio_venta_abastecer" name="precio_venta_abastecer">
                        </div>
